...
import com.alan.springbootmicroservice3apigateway.request.CompraServiceRequest;
...
public class CompraController {
    ...
    @GetMapping
    public ResponseEntity<?> gettAllComprasOfUser(@AuthenticationPrincipal UserPrincipal userPrincipal){
